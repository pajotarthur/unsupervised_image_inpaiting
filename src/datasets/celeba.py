...
class RealValIteratorCelebA(Dataset):
    def __init__(self, filename: str, is_train: bool = True, measurement=None, im_size=None):
        ...
        print("loaded {} of size : {}".format(filename, self.total))
